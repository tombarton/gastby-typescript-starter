...
export type FluidImageQueryVariables = Exact<{ [key: string]: never; }>;


export type FluidImageQuery = { placeholderImage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> };
